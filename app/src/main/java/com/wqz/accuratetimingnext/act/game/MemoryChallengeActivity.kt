 ...
 */
@AndroidEntryPoint
class MemoryChallengeActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            XBackground.Breathing(
                titleId = R.string.memory_challenge
            ) {
                ...
                if (actualTimes.size == expectedTimes.size && errorTimes.size == expectedTimes.size) {
                    ...
                    gameRecordViewModel.insert(
                        gameRecord = GameRecord(
                            ...
                            gameTag = ModeTranslator.getChineseName(mode = Mode.MEMORY_MODE)
                        )
                    )
        ...
        XCard.Lively {
            ...
            Text(
                ...
                modifier = Modifier.clickVfx {
                    val intent =
                        Intent(this@MemoryChallengeActivity, ErrorDetailsActivity::class.java)
                    val bundle = Bundle()
                    bundle.putLongArray(
                        "EXPECTED_TIMES",
